...
STICKERS = (
    "CAACAgUAAxkDAAJCAmCrqfnbbXzN-ztQ0k0_-fffuOIkAAJ4AQACmqa_HQfboOA1NkEJHgQ",
    "CAACAgUAAxkDAAJCBWCrqi1LbVcXRm9Pgjctpdu63Jy3AAIaAgACmqa_HQFTzT2xaLogHgQ",
    "CAACAgUAAxkDAAJCBmCrqjFRWt8f5YdHNSBiGazA00JhAAKuAQACmqa_HST5TaUBr2CTHgQ",
    "CAACAgUAAxkDAAJCB2Crqjdt53Ly5F0IK7MGbcxazvPgAAJzAQACmqa_HWkbtUjs_cF5HgQ",
)
...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings["btn_source"], url="https://t.me/race_up"
        ),
    )
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/askyourmovies_101"),
        InlineKeyboardButton(
            strings["btn_group"], url="https://t.me/askyourmovies_101"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
